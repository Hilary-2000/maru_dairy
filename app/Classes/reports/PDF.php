...
class PDF extends FPDF
{
    ...
    {
        // Logo
        $this->Image(dirname(__FILE__) . $this->company_logo, 3, 8, 30);
        // Arial  15
        ...
        $this->Cell($this->company_header_position, 5, "Tel: " . $this->company_contact, 0, 0, 'C');
        $this->Ln();
        $this->SetFont('Arial', '', 10);
        $this->Cell($this->company_header_position, 5, "email: " . $this->company_email, 0, 0, 'C');
